...
require.register("data-provider", function(exports, require, module) {
...
require.register("backbone.stickit", function(exports, require, module) {
//
...
require.register("moment", function(exports, require, module) {
//! moment.js
//! version : 2.8.4
...
require.register("zoom/jquery.zoom", function(exports, require, module) {
/*!
	Zoom 1.7.13
	license: MIT
...
require.register("lib/query-string", function(exports, require, module) {
var _ = require('underscore');
...
require.register("lib/stickit.helpers", function(exports, require, module) {
...
require.register("models/results_model", function(exports, require, module) {
var Backbone = require('backbone');
...
require.register("views/templates/filter", function(exports, require, module) {
...
var jade_mixins = {};
var jade_interp;
var locals_ = (locals || {}),count = locals_.count,pools = locals_.pools,statusInterval = locals_.statusInterval;
if ( count <= 0)
{
...
{
buf.push("<div id=\"results-count\">Results: " + (jade.escape((jade_interp = count) == null ? '' : jade_interp)) + "</div>");
// iterate pools
;(function(){
  var $$obj = pools;
  if ('number' == typeof $$obj.length) {
...
buf.push("<span" + (jade.attr("data-filter", {type: 'name', level: index, value: name}, true, false)) + " class=\"add-filter hierarchy\">" + (jade.escape(null == (jade_interp = name) ? "" : jade_interp)) + "</span>");
    }
